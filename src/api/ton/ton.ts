import { Address, TonClient, beginCell, storeStateInit, toNano, Cell } from '@ton/ton'
...
export async function sendTransaction(tonConnectUI: TonConnectUI) {
    ...
    const senderAddress = getJettonAddress(tonConnectUI.account?.address!, gramWalletCode, gramMasterAddress);
